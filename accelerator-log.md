...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=fullaware&repo=tanzu-java-web-app",
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=fullaware&repo=tanzu-java-web-app'
